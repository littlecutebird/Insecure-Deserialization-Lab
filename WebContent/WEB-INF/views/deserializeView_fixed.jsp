...
<body>
	...
	<div class="container">
		...
		<p>Submit base64 string and get your information! But this time, the function is not vulnerable to IS</p>
		<form method="POST" action="${pageContext.request.contextPath}/safecheck">
